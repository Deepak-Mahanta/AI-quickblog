...
export const addBlog = async (req, res) => {
  try {
    ...
    //  first upload image at cloudrinary so convert image  file into base 64 image (based on ImageKit documents)
    ...
    const optimizedUrl = imagekit.url({
      ...
      transformation: [
        { quality: "auto" }, // auto comperession
        { format: "webp" }, // convert morden format
...
export const deletetBlogById = async (req, res) => {
  try {
    const { id } = req.body;
